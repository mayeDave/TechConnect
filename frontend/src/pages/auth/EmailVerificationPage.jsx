    ...
    <div className="grid lg:grid-cols-2">
      ...
      >
        <div className="max-w-md w-full pt-4 bg-base-300 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden">
          ...
          <h3 className="text-3xl font-bold mb-6 text-center bg-gradient-to-r from-base-content to-base-content/45 text-transparent bg-clip-text">
              Verify Your Email, from your inbox or check spam
            </h3>
